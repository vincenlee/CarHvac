...
public class TemperatureBarOverlay extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        // 将折叠的圆圈一直向下推到屏幕底部，使其一半可见。
        mCollapsedYShift = (mCollapsedHeight / 2);
        // 扩展面板的中心。mCollapsedYShift的额外推动是为了弥补重力设置为底部的事实。
    ...
    private final OnClickListener temperatureClickListener = new OnClickListener() {
        @Override
    ...
    /**
     * 设置温度栏是否打开。如果它是关闭的，它应该显示“关闭”，而不是温度。
     */
